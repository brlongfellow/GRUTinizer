...
void MakeHistograms(TRuntimeObjects& obj) {
  ...
  if(!newal23blob) {
    TPreserveGDirectory Preserve;
    TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/newal23blob159.root");
    newal23blob = (TCutG*)fcut.Get("newal23blob159");
  }
  static TCutG *newsi24blob = 0;
  if(!newsi24blob) {
    TPreserveGDirectory Preserve;
    TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/newsi24blob159.root");
    newsi24blob = (TCutG*)fcut.Get("newsi24blob159");
  }
  static TCutG *newmg22blob = 0;
  if(!newmg22blob) {
    TPreserveGDirectory Preserve;
    TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/newmg22blob159.root");
    newmg22blob = (TCutG*)fcut.Get("newmg22blob159");
  }
  static TCutG *newmg23blob = 0;
  if(!newmg23blob) {
    TPreserveGDirectory Preserve;
    TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/newmg23blob159.root");
    newmg23blob = (TCutG*)fcut.Get("newmg23blob159");
  }
