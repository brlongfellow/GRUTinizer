...
void MakeHistograms(TRuntimeObjects& obj) {
  ...
  if(!timingcut_p26) {
    TPreserveGDirectory Preserve;
    TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/timeenergy_p26.root");
  ...
  if(!InBeam_Above) {
    TPreserveGDirectory Preserve;
    TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/newabove.root");
    InBeam_Above = (TCutG*)fcut.Get("Inbeam_above");
  }
  static TCutG *ne17blobtop = 0;
  if(!ne17blobtop) {
     TPreserveGDirectory Preserve;
     TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/ne17blobtop.root");
     ne17blobtop = (TCutG*)fcut.Get("ne17top");
  }
  static TCutG *ne17blobbetween = 0;
  if(!ne17blobbetween) {
     TPreserveGDirectory Preserve;
     TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/ne17blobbetween.root");
     ne17blobbetween = (TCutG*)fcut.Get("ne17between");
  }
  static TCutG *mg20blobtop = 0;
  if(!mg20blobtop) {
     TPreserveGDirectory Preserve;
     TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/mg20blobtop.root");
     mg20blobtop = (TCutG*)fcut.Get("mg20top");
  }
  static TCutG *al24blobbetween = 0;
  if(!al24blobbetween) {
     TPreserveGDirectory Preserve;
     TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/al24blobbetween.root");
     al24blobbetween = (TCutG*)fcut.Get("al24between");
  }
  static TCutG *p26blobtop = 0;
  if(!p26blobtop) {
     TPreserveGDirectory Preserve;
     TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/p26blobtop.root");
     p26blobtop = (TCutG*)fcut.Get("p26top");
  }
  static TCutG *p26blobabove = 0;
  if(!p26blobabove) {
     TPreserveGDirectory Preserve;
     TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/p26blobabove.root");
     p26blobabove = (TCutG*)fcut.Get("p26above");
  }
  static TCutG *si25blobtop = 0;
  if(!si25blobtop) {
     TPreserveGDirectory Preserve;
     TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/si25blobtop2.root");
  ...
  if(caesar) {
	...
	double xfptac_m = s800->GetTof().GetTacXFP();
        ...
        //if(si25blobtop->IsInside(objtac_corr_m,ic_sum_m) && InBeam_Top->IsInside(objtac_m,xfptac_m))
          //ng_si25blobtop++;
	...
	double xfp_focalplane = s800->GetXFP(0);
	  ...
	  if(InBeam_Mid->IsInside(objtac,xfptac)){
		...
		obj.FillHistogram("GATED",histname,
          ...
          //if(si25blobtop->IsInside(objtac_corr,ic_sum) && InBeam_Top->IsInside(objtac,xfptac)){
	        ...
	        double ic_sum2 = s800->GetIonChamber().GetAve();
	        double objtac_corr2 = s800->GetCorrTOF_OBJTAC();
	        double objtac2 = s800->GetTof().GetTacOBJ();
	        double xfptac2 = s800->GetTof().GetTacXFP();
	        double afp2 = s800->GetAFP();
	        double xfp_focalplane2 = s800->GetXFP(0);
                TVector3 track2 = s800->Track();
                double corr_time2 = caesar->GetCorrTime(hit2,s800);
              
                if(si25blobtop->IsInside(objtac_corr2,ic_sum2) && InBeam_Top->IsInside(objtac2,xfptac2) && timingcut_si25->IsInside(corr_time2,hit2.GetEnergy())){
                  if(hit.GetEnergy() > 100 && hit2.GetEnergy() > 100){
                    obj.FillHistogram("Caesar_GATED","Coinc_Time_Dif_Si25",2000,-2000,2000,corr_time - corr_time2);
                  }
                }
              }     
            }
