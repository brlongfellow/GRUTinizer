...
void MakeHistograms(TRuntimeObjects& obj) {
  ...
  double    beta = 0.391;
  double    beta_al23 = 0.416;
  double    beta_si24 = 0.427;
  double    beta_mg22 = 0.404;
  double    beta_mg23 = 0.391;
  double    z_shift = 0.65;
  ...
  if(!newal23blob) {
    TPreserveGDirectory Preserve;
    TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/newal23blob158.root");
    newal23blob = (TCutG*)fcut.Get("newal23blob158");
  }
  static TCutG *newsi24blob = 0;
  if(!newsi24blob) {
    TPreserveGDirectory Preserve;
    TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/newsi24blob158.root");
    newsi24blob = (TCutG*)fcut.Get("newsi24blob158");
  }
  static TCutG *newmg22blob = 0;
  if(!newmg22blob) {
    TPreserveGDirectory Preserve;
    TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/newmg22blob158.root");
    newmg22blob = (TCutG*)fcut.Get("newmg22blob158");
  }
  static TCutG *newmg23blob = 0;
  if(!newmg23blob) {
    TPreserveGDirectory Preserve;
    TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/newmg23blob158.root");
    newmg23blob = (TCutG*)fcut.Get("newmg23blob158");
  }
