...
void MakeHistograms(TRuntimeObjects& obj) {
  ...
  double    beta = 0.401;
  double    beta_al23 = 0.427;
  double    beta_si24 = 0.438;
  double    beta_mg22 = 0.415;
  double    beta_mg23 = 0.401;
  double    z_shift = 0.65;
  ...
  if(!newal23blob) {
    TPreserveGDirectory Preserve;
    TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/newal23blob155.root");
    newal23blob = (TCutG*)fcut.Get("newal23blob155");
  }
  static TCutG *newsi24blob = 0;
  if(!newsi24blob) {
    TPreserveGDirectory Preserve;
    TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/newsi24blob155.root");
    newsi24blob = (TCutG*)fcut.Get("newsi24blob155");
  }
  static TCutG *newmg22blob = 0;
  if(!newmg22blob) {
    TPreserveGDirectory Preserve;
    TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/newmg22blob155.root");
    newmg22blob = (TCutG*)fcut.Get("newmg22blob155");
  }
  static TCutG *newmg23blob = 0;
  if(!newmg23blob) {
    TPreserveGDirectory Preserve;
    TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/newmg23blob155.root");
    newmg23blob = (TCutG*)fcut.Get("newmg23blob155");
  }
