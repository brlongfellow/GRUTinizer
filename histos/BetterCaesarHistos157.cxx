...
void MakeHistograms(TRuntimeObjects& obj) {
  ...
  double    beta = 0.392;
  double    beta_al23 = 0.418;
  double    beta_si24 = 0.429;
  double    beta_mg22 = 0.406;
  double    beta_mg23 = 0.392;
  double    z_shift = 0.65;
  ...
  if(!newal23blob) {
    TPreserveGDirectory Preserve;
    TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/newal23blob157.root");
    newal23blob = (TCutG*)fcut.Get("newal23blob157");
  }
  static TCutG *newsi24blob = 0;
  if(!newsi24blob) {
    TPreserveGDirectory Preserve;
    TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/newsi24blob157.root");
    newsi24blob = (TCutG*)fcut.Get("newsi24blob157");
  }
  static TCutG *newmg22blob = 0;
  if(!newmg22blob) {
    TPreserveGDirectory Preserve;
    TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/newmg22blob157.root");
    newmg22blob = (TCutG*)fcut.Get("newmg22blob157");
  }
  static TCutG *newmg23blob = 0;
  if(!newmg23blob) {
    TPreserveGDirectory Preserve;
    TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/newmg23blob157.root");
    newmg23blob = (TCutG*)fcut.Get("newmg23blob157");
  }
