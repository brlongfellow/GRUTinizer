...
void MakeHistograms(TRuntimeObjects& obj) {
  ...
  if(!InBeam_Above) {
    TPreserveGDirectory Preserve;
    TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/newabove140.root");
    InBeam_Above = (TCutG*)fcut.Get("Inbeam_above140");
  }
  ...
  if(!p26blobtop) {
     TPreserveGDirectory Preserve;
     TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/p26blobtop140.root");
     p26blobtop = (TCutG*)fcut.Get("p26top140");
  }
  static TCutG *p26blobabove = 0;
  if(!p26blobabove) {
     TPreserveGDirectory Preserve;
     TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/p26blobabove140.root");
     p26blobabove = (TCutG*)fcut.Get("p26above140");
  }
  static TCutG *si25blobtop = 0;
  if(!si25blobtop) {
     TPreserveGDirectory Preserve;
     TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/si25blobtop140.root");
     si25blobtop = (TCutG*)fcut.Get("si25top140");
  }
