...
void MakeHistograms(TRuntimeObjects& obj) {
  ...
  double    beta = 0.394;
  double    beta_al23 = 0.419;
  double    beta_si24 = 0.430;
  double    beta_mg22 = 0.407;
  double    beta_mg23 = 0.394;
  double    z_shift = 0.65;
  ...
  if(!newal23blob) {
    TPreserveGDirectory Preserve;
    TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/newal23blob156.root");
    newal23blob = (TCutG*)fcut.Get("newal23blob156");
  }
  static TCutG *newsi24blob = 0;
  if(!newsi24blob) {
    TPreserveGDirectory Preserve;
    TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/newsi24blob156.root");
    newsi24blob = (TCutG*)fcut.Get("newsi24blob156");
  }
  static TCutG *newmg22blob = 0;
  if(!newmg22blob) {
    TPreserveGDirectory Preserve;
    TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/newmg22blob156.root");
    newmg22blob = (TCutG*)fcut.Get("newmg22blob156");
  }
  static TCutG *newmg23blob = 0;
  if(!newmg23blob) {
    TPreserveGDirectory Preserve;
    TFile fcut("/mnt/analysis/pecan-2015/longfellow/e10002/newmg23blob156.root");
    newmg23blob = (TCutG*)fcut.Get("newmg23blob156");
  }
